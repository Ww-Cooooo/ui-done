...
2. Attach the official-demo record for every selected or seriously considered source: exact demo, observed capability, adopted or rejected decision, planned adaptation, and idea-only versus code use; otherwise attach the hard demo-review exemption. A 3D gate failure recorded before any serious candidate exists does not require a demo record.
