...
import { galleryPages, getPageConfig, showcasePages } from "./data";
    ...
    <section className="gallery-hero">
      <div className="gallery-hero-copy">
        ...
        <div data-hero-reveal className="hero-actions">
          <Button type="primary" size="large" href="#works" icon={<ArrowDownOutlined />}>直接看 {galleryPages.length} 个示例</Button>
      ...
      <div className="gallery-dispatch" data-hero-reveal>
        <div className="gallery-task-board" aria-label="六种工作型产品入口">
          ...
          <div className="task-board-foot">
            <span>另外还有 4 个表达型页面和 1 个动效试验台</span><span>内容表达、沉浸体验和可操作动效</span>
          </div>
        </div>
      ...
      <div className="gallery-hero-foot" data-hero-reveal>
        <span>REACT</span><span>ANT DESIGN</span><span>GSAP + ANIME.JS</span><span>ANTV</span><span>REAL WORKFLOWS</span><span>SELECTIVE 3D + CANVAS</span><span>OPEN-SOURCE TYPE</span>
      </div>
    </section>
  );
}
...
export default function GalleryPage({ page, reduced }) {
  return (
